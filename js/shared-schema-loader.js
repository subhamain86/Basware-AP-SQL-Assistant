(function (root) {
  ...
  function describeSharedSchemaStatus(state) {
    ...
    if (!state.found) return { level: 'notfound', text: 'No shared schema was found at "' + (state.path || DEFAULT_SHARED_SCHEMA_PATH) + '" (relative to this page). Using the schema already saved in this browser instead.' };
