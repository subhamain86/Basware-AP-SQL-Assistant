(function (root) {
  ...
  function buildXlsxBlob(header, rows) {
    ...
    var rootRelsXml2 = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="xl/workbook.xml"/></Relationships>';
    var enc2 = new TextEncoder();
    var zipBytes2 = writeZip([{ name: '[Content_Types].xml', data: enc2.encode(contentTypesXml) }, { name: '_rels/.rels', data: enc2.encode(rootRelsXml2) }, { name: 'xl/workbook.xml', data: enc2.encode(workbookXml) }, { name: 'xl/_rels/workbook.xml.rels', data: enc2.encode(workbookRelsXml) }, { name: 'xl/worksheets/sheet1.xml', data: enc2.encode(sheetXml) }, { name: 'xl/sharedStrings.xml', data: enc2.encode(sstXml) }]);
    return new Blob([zipBytes2], { type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
  }
